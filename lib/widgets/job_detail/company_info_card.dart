...
class CompanyInfoCard extends StatelessWidget {
  ...
  job; // Thuộc tính job, chứa thông tin chi tiết về công ty và công việc.
        ...
        children: [
          ...
          Image.asset(
            job['companyLogoAsset'] ??
                'assets/images/company_logo.png', // Đường dẫn asset logo lấy từ job.
          ...
          const SizedBox(
            width: 16,
          ), // Khoảng cách ngang 16px giữa logo và thông tin.
          Expanded(
            // Expanded để phần thông tin chiếm hết không gian còn lại.
            child: Column(
              crossAxisAlignment: CrossAxisAlignment
                  .start, // Căn lề trái cho các dòng thông tin.
              children: [
